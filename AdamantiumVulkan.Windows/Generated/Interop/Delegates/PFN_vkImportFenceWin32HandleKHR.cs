...
public unsafe struct PFN_vkImportFenceWin32HandleKHR
{
    ...
    public static Result Invoke(nuint ptr, AdamantiumVulkan.Core.Interop.VkDevice_T device, AdamantiumVulkan.Windows.Interop.VkImportFenceWin32HandleInfoKHR* pImportFenceWin32HandleInfo)
    {
        return ((delegate* unmanaged<AdamantiumVulkan.Core.Interop.VkDevice_T, AdamantiumVulkan.Windows.Interop.VkImportFenceWin32HandleInfoKHR*, Result>)(void*)ptr)(device, pImportFenceWin32HandleInfo);
    }
