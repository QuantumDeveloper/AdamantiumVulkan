...
// File: C:\VulkanSDK\1.4.350.0\Include\spirv-tools\libspirv.h Line: 549 Column: 32
public unsafe partial class spv_reducer_options : IUnmanagedWrapper<Adamantium.Vulkan.SpirvTools.Interop.spv_reducer_options_t>
{
    ...
    public spv_reducer_options(in Adamantium.Vulkan.SpirvTools.Interop.spv_reducer_options_t __Instance)
    {
        this.__Instance = __Instance;
    }

    public Adamantium.Vulkan.SpirvTools.Interop.spv_reducer_options_t GetNativeValue() => __Instance;
    ///<summary>
    ...
    {
        return Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvReducerOptionsCreate();
    }
    ...
    {
        Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvReducerOptionsDestroy(this);
    }
    ...
    {
        Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvReducerOptionsSetFailOnValidationError(this, fail_on_validation_error);
    }
    ...
    {
        Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvReducerOptionsSetStepLimit(this, step_limit);
    }
    ...
    {
        return s?.__Instance ?? new Adamantium.Vulkan.SpirvTools.Interop.spv_reducer_options_t();
    }

    public static implicit operator spv_reducer_options(Adamantium.Vulkan.SpirvTools.Interop.spv_reducer_options_t s)
    {
        return new spv_reducer_options(in s);
    }
