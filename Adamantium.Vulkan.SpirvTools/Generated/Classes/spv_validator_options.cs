...
public unsafe partial class spv_validator_options : IUnmanagedWrapper<Adamantium.Vulkan.SpirvTools.Interop.spv_validator_options_t>
{
    ...
    public spv_validator_options(in Adamantium.Vulkan.SpirvTools.Interop.spv_validator_options_t __Instance)
    {
    ...
    {
        return Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvValidatorOptionsCreate();
    }
    ...
    {
        Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvValidatorOptionsDestroy(this);
    }
    ...
    {
        Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvValidatorOptionsSetAllowLocalSizeId(this, val);
    }
    ...
    {
        Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvValidatorOptionsSetAllowOffsetTextureOperand(this, val);
    }
    ...
    {
        Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvValidatorOptionsSetAllowVulkan32BitBitwise(this, val);
    }
    ...
    {
        Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvValidatorOptionsSetBeforeHlslLegalization(this, val);
    }
    ...
    {
        Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvValidatorOptionsSetFriendlyNames(this, val);
    }
    ...
    {
        Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvValidatorOptionsSetRelaxBlockLayout(this, val);
    }
    ...
    {
        Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvValidatorOptionsSetRelaxLogicalPointer(this, val);
    }
    ...
    {
        Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvValidatorOptionsSetRelaxStoreStruct(this, val);
    }
    ...
    {
        Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvValidatorOptionsSetScalarBlockLayout(this, val);
    }
    ...
    {
        Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvValidatorOptionsSetSkipBlockLayout(this, val);
    }
    ...
    {
        Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvValidatorOptionsSetUniformBufferStandardLayout(this, val);
    }
    ...
    {
        Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvValidatorOptionsSetUniversalLimit(this, limit_type, limit);
    }
    ...
    {
        return s?.__Instance ?? new Adamantium.Vulkan.SpirvTools.Interop.spv_validator_options_t();
    }

    public static implicit operator spv_validator_options(Adamantium.Vulkan.SpirvTools.Interop.spv_validator_options_t s)
    {
        return new spv_validator_options(in s);
    }
