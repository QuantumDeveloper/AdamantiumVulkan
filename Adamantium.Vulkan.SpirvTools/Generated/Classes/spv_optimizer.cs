...
public unsafe partial class spv_optimizer : IUnmanagedWrapper<Adamantium.Vulkan.SpirvTools.Interop.spv_optimizer_t>
{
    ...
    public spv_optimizer(Adamantium.Vulkan.SpirvTools.Interop.spv_optimizer_t __Instance)
    {
        this.__Instance = __Instance;
    }

    public Adamantium.Vulkan.SpirvTools.Interop.spv_optimizer_t GetNativeValue() => __Instance;
    ...
    public void SpvOptimizerDestroy()
    {
        ...
        Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvOptimizerDestroy(&nativeInstance);
    }
    ...
    {
        var nativeInstance = GetNativeValue();
        Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvOptimizerRegisterLegalizationPasses(&nativeInstance);
    }
    ...
    public bool SpvOptimizerRegisterPassesFromFlags(string[] flags, ulong flag_count)
    {
        ...
        fixed (byte* bufferPtr = mainBuffer)
        {
            try
            {
                ...
                return Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvOptimizerRegisterPassesFromFlags(&nativeInstance, arg1, flag_count);
            }
            finally
            {
                if (rentedArray != null)
    ...
    public bool SpvOptimizerRegisterPassesFromFlagsWhilePreservingTheInterface(string[] flags, ulong flag_count)
    {
        ...
        fixed (byte* bufferPtr = mainBuffer)
        {
            try
            {
                ...
                var nativeInstance = GetNativeValue();
                var arg1 = QuantumBinding.Utils.MarshalContextUtils.MarshalStringArray(flags, ref currentCursor);
                return Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvOptimizerRegisterPassesFromFlagsWhilePreservingTheInterface(&nativeInstance, arg1, flag_count);
            }
            finally
            {
                if (rentedArray != null)
    ...
    public bool SpvOptimizerRegisterPassFromFlag(string flag)
    {
        ...
        fixed (byte* bufferPtr = mainBuffer)
        {
            try
            {
                ...
                return Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvOptimizerRegisterPassFromFlag(&nativeInstance, arg1);
            }
            finally
            {
                if (rentedArray != null)
    ...
    {
        var nativeInstance = GetNativeValue();
        Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvOptimizerRegisterPerformancePasses(&nativeInstance);
    }
    ...
    {
        var nativeInstance = GetNativeValue();
        Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvOptimizerRegisterSizePasses(&nativeInstance);
    }
    ...
    ///</summary>
    public spv_result_t SpvOptimizerRun(in uint binary, ulong word_count, out Adamantium.Vulkan.SpirvTools.spv_binary optimized_binary, Adamantium.Vulkan.SpirvTools.spv_optimizer_options options)
    {
        var nativeInstance = GetNativeValue();
        ...
        *arg1 = binary;
        ...
        var result = Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvOptimizerRun(&nativeInstance, arg1, word_count, &arg3, arg4);
    ...
    {
        return s?.__Instance ?? new Adamantium.Vulkan.SpirvTools.Interop.spv_optimizer_t();
    }

    public static implicit operator spv_optimizer(Adamantium.Vulkan.SpirvTools.Interop.spv_optimizer_t s)
    {
