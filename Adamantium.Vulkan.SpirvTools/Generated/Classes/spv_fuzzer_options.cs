...
// File: C:\VulkanSDK\1.4.350.0\Include\spirv-tools\libspirv.h Line: 551 Column: 31
public unsafe partial class spv_fuzzer_options : IUnmanagedWrapper<Adamantium.Vulkan.SpirvTools.Interop.spv_fuzzer_options_t>
{
    ...
    public spv_fuzzer_options(in Adamantium.Vulkan.SpirvTools.Interop.spv_fuzzer_options_t __Instance)
    {
        this.__Instance = __Instance;
    }

    public Adamantium.Vulkan.SpirvTools.Interop.spv_fuzzer_options_t GetNativeValue() => __Instance;
    ///<summary>
    ...
    {
        return Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvFuzzerOptionsCreate();
    }
    ...
    {
        Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvFuzzerOptionsDestroy(this);
    }
    ...
    {
        Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvFuzzerOptionsEnableAllPasses(this);
    }
    ...
    {
        Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvFuzzerOptionsEnableFuzzerPassValidation(this);
    }
    ...
    {
        Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvFuzzerOptionsEnableReplayValidation(this);
    }
    ...
    {
        Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvFuzzerOptionsSetRandomSeed(this, seed);
    }
    ...
    {
        Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvFuzzerOptionsSetReplayRange(this, replay_range);
    }
    ...
    {
        return s?.__Instance ?? new Adamantium.Vulkan.SpirvTools.Interop.spv_fuzzer_options_t();
    }

    public static implicit operator spv_fuzzer_options(Adamantium.Vulkan.SpirvTools.Interop.spv_fuzzer_options_t s)
    {
        return new spv_fuzzer_options(in s);
    }
