...
public unsafe static class SpirvToolsNative
{
    ...
    {
        return Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvOperandIsConcrete(type);
    }
    ...
    {
        return Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvOperandIsConcreteMask(type);
    }
    ...
    {
        var result = Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvSoftwareVersionString();
    ...
    {
        var result = Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvSoftwareVersionDetailsString();
        return new string(result);
    }
    ...
    {
        var result = Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvTargetEnvDescription(env);
        return new string(result);
    }
    ...
    public static bool SpvParseTargetEnv(string s, ref spv_target_env env)
    {
        ...
        fixed (byte* bufferPtr = mainBuffer)
        {
            try
            {
                ...
                var arg1 = stackalloc Adamantium.Vulkan.SpirvTools.spv_target_env[1];
                *arg1 = env;
                var result = Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvParseTargetEnv(arg0, arg1);
                if (arg1 is not null)
                {
                    env = *arg1;
                }
    ...
    {
        var arg2 = stackalloc Adamantium.Vulkan.SpirvTools.spv_target_env[1];
        *arg2 = env;
        var result = Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvParseVulkanEnv(vulkan_ver, spirv_ver, arg2);
        if (arg2 is not null)
        {
            env = *arg2;
        }
    ...
    {
        return Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvContextCreate(env);
    }
    ...
    {
        var result = Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvOpcodeString(opcode);
        return new string(result);
    }
    ...
    {
        var result = Adamantium.Vulkan.SpirvTools.Interop.SpirvToolsInterop.spvOptimizerCreate(env);
