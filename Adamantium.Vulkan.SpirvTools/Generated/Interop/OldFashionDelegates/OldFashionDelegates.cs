...
public static unsafe class Delegates
{
    ...
    ///</summary>
    [UnmanagedFunctionPointer(CallingConvention.Winapi)]
    public unsafe delegate spv_result_t spv_parsed_instruction_fn_t(void* user_data, Adamantium.Vulkan.SpirvTools.Interop.spv_parsed_instruction_t* parsed_instruction);
    ...
    ///</summary>
    [UnmanagedFunctionPointer(CallingConvention.Winapi)]
    public unsafe delegate void spv_message_consumer(spv_message_level_t param0, sbyte* param1, Adamantium.Vulkan.SpirvTools.Interop.spv_position_t* param2, sbyte* param3);
}
