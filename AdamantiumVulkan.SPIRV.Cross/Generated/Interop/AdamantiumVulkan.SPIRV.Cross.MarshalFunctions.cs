...
namespace AdamantiumVulkan.SPIRV.Cross.Interop
{
    ...
    public static class SpirvCrossInterop
    {
        ...
        internal static extern SpvcResult spvc_compiler_create_shader_resources_for_active_variables([In] AdamantiumVulkan.SPIRV.Cross.Interop.SpvcCompilerS compiler, [Out] out AdamantiumVulkan.SPIRV.Cross.Interop.SpvcResourcesS resources, [In] SpvcSet active);
        ...
        internal static extern SpvcResult spvc_compiler_get_active_interface_variables([In] AdamantiumVulkan.SPIRV.Cross.Interop.SpvcCompilerS compiler, [Out] out SpvcSet set);
        ...
        internal static extern SpvcResult spvc_compiler_get_declared_struct_member_size([In] AdamantiumVulkan.SPIRV.Cross.Interop.SpvcCompilerS compiler, [In] SpvcType type, [In] uint index, ref ulong size);
        ...
        internal static extern SpvcResult spvc_compiler_get_declared_struct_size([In] AdamantiumVulkan.SPIRV.Cross.Interop.SpvcCompilerS compiler, [In] SpvcType struct_type, ref ulong size);
        ...
        internal static extern SpvcResult spvc_compiler_get_declared_struct_size_runtime_array([In] AdamantiumVulkan.SPIRV.Cross.Interop.SpvcCompilerS compiler, [In] SpvcType struct_type, [In] ulong array_size, ref ulong size);
        ...
        internal static extern SpvcType spvc_compiler_get_type_handle([In] AdamantiumVulkan.SPIRV.Cross.Interop.SpvcCompilerS compiler, [In] uint id);
        ...
        internal static extern SpvcResult spvc_compiler_set_enabled_interface_variables([In] AdamantiumVulkan.SPIRV.Cross.Interop.SpvcCompilerS compiler, [In] SpvcSet set);
        ...
        internal static extern SpvcResult spvc_compiler_type_struct_member_array_stride([In] AdamantiumVulkan.SPIRV.Cross.Interop.SpvcCompilerS compiler, [In] SpvcType type, [In] uint index, ref uint stride);
        ...
        internal static extern SpvcResult spvc_compiler_type_struct_member_matrix_stride([In] AdamantiumVulkan.SPIRV.Cross.Interop.SpvcCompilerS compiler, [In] SpvcType type, [In] uint index, ref uint stride);

        [DllImport(LibraryPath, EntryPoint = "spvc_compiler_type_struct_member_offset", CallingConvention = CallingConvention.Winapi)]
        internal static extern SpvcResult spvc_compiler_type_struct_member_offset([In] AdamantiumVulkan.SPIRV.Cross.Interop.SpvcCompilerS compiler, [In] SpvcType type, [In] uint index, ref uint offset);
