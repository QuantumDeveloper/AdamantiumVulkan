...
public static unsafe class Delegates
{
    ...
    public unsafe delegate spv_result_t spv_parsed_header_fn_t(nuint user_data, spv_endianness_t endian, uint magic, uint version, uint generator, uint id_bound, uint reserved);
    ...
    ///</summary>
    [UnmanagedFunctionPointer(CallingConvention.Winapi)]
    public unsafe delegate spv_result_t spv_parsed_instruction_fn_t(nuint user_data, AdamantiumVulkan.SpirvTools.Interop.spv_parsed_instruction_t* parsed_instruction);
