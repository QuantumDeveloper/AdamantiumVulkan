...
public unsafe partial class spv_fuzzer_options : IUnmanagedWrapper<AdamantiumVulkan.SpirvTools.Interop.spv_fuzzer_options_t>
{
    ...
    public spv_fuzzer_options(in AdamantiumVulkan.SpirvTools.Interop.spv_fuzzer_options_t __Instance)
    {
