...
public unsafe partial class SurfaceKHR : IUnmanagedWrapper<AdamantiumVulkan.Core.Interop.VkSurfaceKHR_T>
{
    ...
    public SurfaceKHR(in AdamantiumVulkan.Core.Interop.VkSurfaceKHR_T __Instance)
    {
