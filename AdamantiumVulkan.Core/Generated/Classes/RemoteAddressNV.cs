...
public unsafe partial class RemoteAddressNV : IUnmanagedWrapper<AdamantiumVulkan.Core.Interop.VkRemoteAddressNVImpl>
{
    ...
    public RemoteAddressNV(in AdamantiumVulkan.Core.Interop.VkRemoteAddressNVImpl __Instance)
    {
        this.__Instance = __Instance;
    }

    public AdamantiumVulkan.Core.Interop.VkRemoteAddressNVImpl GetNativeValue() => __Instance;
    ...
    {
        return new RemoteAddressNV(in r);
    }
