...
public unsafe partial class AccelerationStructureKHR : IUnmanagedWrapper<AdamantiumVulkan.Core.Interop.VkAccelerationStructureKHR_T>
{
    ...
    public AccelerationStructureKHR(in AdamantiumVulkan.Core.Interop.VkAccelerationStructureKHR_T __Instance)
    {
        this.__Instance = __Instance;
    }

    public AdamantiumVulkan.Core.Interop.VkAccelerationStructureKHR_T GetNativeValue() => __Instance;
