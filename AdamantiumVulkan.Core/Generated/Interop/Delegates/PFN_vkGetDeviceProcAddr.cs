...
public unsafe struct PFN_vkGetDeviceProcAddr
{
    ...
    public static void* Invoke(nuint ptr, AdamantiumVulkan.Core.Interop.VkDevice_T device, sbyte* pName)
    {
        return ((delegate* unmanaged<AdamantiumVulkan.Core.Interop.VkDevice_T, sbyte*, void*>)(void*)ptr)(device, pName);
    }
