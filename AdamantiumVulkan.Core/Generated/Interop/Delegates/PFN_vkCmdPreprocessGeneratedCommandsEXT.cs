...
public unsafe struct PFN_vkCmdPreprocessGeneratedCommandsEXT
{
    ...
    {
        NativePointer = ptr;
        InvokeFunc = (delegate* unmanaged<AdamantiumVulkan.Core.Interop.VkCommandBuffer_T, AdamantiumVulkan.Core.Interop.VkGeneratedCommandsInfoEXT*, AdamantiumVulkan.Core.Interop.VkCommandBuffer_T, void>)ptr;
    }

    private delegate* unmanaged<AdamantiumVulkan.Core.Interop.VkCommandBuffer_T, AdamantiumVulkan.Core.Interop.VkGeneratedCommandsInfoEXT*, AdamantiumVulkan.Core.Interop.VkCommandBuffer_T, void> InvokeFunc;

    public void* NativePointer { get; }

    public void Invoke(AdamantiumVulkan.Core.Interop.VkCommandBuffer_T commandBuffer, AdamantiumVulkan.Core.Interop.VkGeneratedCommandsInfoEXT* pGeneratedCommandsInfo, AdamantiumVulkan.Core.Interop.VkCommandBuffer_T stateCommandBuffer)
    {
         InvokeFunc(commandBuffer, pGeneratedCommandsInfo, stateCommandBuffer);
    }
    public static void Invoke(void* ptr, AdamantiumVulkan.Core.Interop.VkCommandBuffer_T commandBuffer, AdamantiumVulkan.Core.Interop.VkGeneratedCommandsInfoEXT* pGeneratedCommandsInfo, AdamantiumVulkan.Core.Interop.VkCommandBuffer_T stateCommandBuffer)
    {
