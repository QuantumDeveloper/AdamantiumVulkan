...
{
    public PFN_vkCmdPushDescriptorSetWithTemplate2KHR(nuint ptr) : this((void*) ptr) { }
    ...
    public static explicit operator PFN_vkCmdPushDescriptorSetWithTemplate2KHR(nuint ptr) => new(ptr);
}
