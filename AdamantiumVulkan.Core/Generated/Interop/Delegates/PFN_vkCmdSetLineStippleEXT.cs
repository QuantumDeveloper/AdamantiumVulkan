...
public unsafe struct PFN_vkCmdSetLineStippleEXT
{
    public PFN_vkCmdSetLineStippleEXT(nuint ptr) : this((void*) ptr) { }
    ...
    public static explicit operator PFN_vkCmdSetLineStippleEXT(nuint ptr) => new(ptr);
}
