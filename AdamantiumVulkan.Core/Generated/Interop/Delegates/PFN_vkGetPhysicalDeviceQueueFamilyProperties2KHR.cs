...
{
    public PFN_vkGetPhysicalDeviceQueueFamilyProperties2KHR(nuint ptr) : this((void*) ptr) { }
    ...
    public static explicit operator PFN_vkGetPhysicalDeviceQueueFamilyProperties2KHR(nuint ptr) => new(ptr);
}
