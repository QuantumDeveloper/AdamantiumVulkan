...
public unsafe struct PFN_vkCmdSetPerformanceOverrideINTEL
{
    ...
    public static Result Invoke(nuint ptr, AdamantiumVulkan.Core.Interop.VkCommandBuffer_T commandBuffer, AdamantiumVulkan.Core.Interop.VkPerformanceOverrideInfoINTEL* pOverrideInfo)
    {
        return ((delegate* unmanaged<AdamantiumVulkan.Core.Interop.VkCommandBuffer_T, AdamantiumVulkan.Core.Interop.VkPerformanceOverrideInfoINTEL*, Result>)(void*)ptr)(commandBuffer, pOverrideInfo);
    }
