...
public unsafe struct PFN_vkCmdSetLineStippleKHR
{
    public PFN_vkCmdSetLineStippleKHR(nuint ptr) : this((void*) ptr) { }

    public PFN_vkCmdSetLineStippleKHR(void* ptr)
    {
        NativePointer = ptr;
    ...
    public static void Invoke(nuint ptr, AdamantiumVulkan.Core.Interop.VkCommandBuffer_T commandBuffer, uint lineStippleFactor, ushort lineStipplePattern)
    {
         ((delegate* unmanaged<AdamantiumVulkan.Core.Interop.VkCommandBuffer_T, uint, ushort, void>)(void*)ptr)(commandBuffer, lineStippleFactor, lineStipplePattern);
    }

    public static explicit operator PFN_vkCmdSetLineStippleKHR(void* ptr) => new(ptr);

    public static explicit operator PFN_vkCmdSetLineStippleKHR(nuint ptr) => new(ptr);
}
