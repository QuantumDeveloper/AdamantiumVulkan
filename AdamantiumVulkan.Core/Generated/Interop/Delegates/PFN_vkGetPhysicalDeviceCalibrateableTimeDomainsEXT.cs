...
{
    public PFN_vkGetPhysicalDeviceCalibrateableTimeDomainsEXT(nuint ptr) : this((void*) ptr) { }
    ...
    public static explicit operator PFN_vkGetPhysicalDeviceCalibrateableTimeDomainsEXT(nuint ptr) => new(ptr);
}
