...
{
    public PFN_vkCmdDrawIndexedIndirectCountKHR(nuint ptr) : this((void*) ptr) { }
    ...
    public static explicit operator PFN_vkCmdDrawIndexedIndirectCountKHR(nuint ptr) => new(ptr);
}
