...
public unsafe struct PFN_vkGetImageSparseMemoryRequirements
{
    ...
    public static void Invoke(nuint ptr, AdamantiumVulkan.Core.Interop.VkDevice_T device, AdamantiumVulkan.Core.Interop.VkImage_T image, ref uint pSparseMemoryRequirementCount, AdamantiumVulkan.Core.Interop.VkSparseImageMemoryRequirements* pSparseMemoryRequirements)
    {
         ((delegate* unmanaged<AdamantiumVulkan.Core.Interop.VkDevice_T, AdamantiumVulkan.Core.Interop.VkImage_T, ref uint, AdamantiumVulkan.Core.Interop.VkSparseImageMemoryRequirements*, void>)(void*)ptr)(device, image, ref pSparseMemoryRequirementCount, pSparseMemoryRequirements);
    }
