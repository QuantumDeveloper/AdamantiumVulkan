...
public unsafe struct PFN_vkCmdSetCheckpointNV
{
    ...
    public static void Invoke(nuint ptr, AdamantiumVulkan.Core.Interop.VkCommandBuffer_T commandBuffer, void* pCheckpointMarker)
    {
         ((delegate* unmanaged<AdamantiumVulkan.Core.Interop.VkCommandBuffer_T, void*, void>)(void*)ptr)(commandBuffer, pCheckpointMarker);
    }
