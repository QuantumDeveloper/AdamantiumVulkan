...
{
    public PFN_vkCmdSetRasterizerDiscardEnableEXT(nuint ptr) : this((void*) ptr) { }
    ...
    public static explicit operator PFN_vkCmdSetRasterizerDiscardEnableEXT(nuint ptr) => new(ptr);
}
