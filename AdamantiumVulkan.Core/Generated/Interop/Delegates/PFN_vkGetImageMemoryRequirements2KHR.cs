...
{
    public PFN_vkGetImageMemoryRequirements2KHR(nuint ptr) : this((void*) ptr) { }
    ...
    public static void Invoke(nuint ptr, AdamantiumVulkan.Core.Interop.VkDevice_T device, AdamantiumVulkan.Core.Interop.VkImageMemoryRequirementsInfo2* pInfo, AdamantiumVulkan.Core.Interop.VkMemoryRequirements2* pMemoryRequirements)
    {
         ((delegate* unmanaged<AdamantiumVulkan.Core.Interop.VkDevice_T, AdamantiumVulkan.Core.Interop.VkImageMemoryRequirementsInfo2*, AdamantiumVulkan.Core.Interop.VkMemoryRequirements2*, void>)(void*)ptr)(device, pInfo, pMemoryRequirements);
    }

    public static explicit operator PFN_vkGetImageMemoryRequirements2KHR(void* ptr) => new(ptr);

    public static explicit operator PFN_vkGetImageMemoryRequirements2KHR(nuint ptr) => new(ptr);
}
