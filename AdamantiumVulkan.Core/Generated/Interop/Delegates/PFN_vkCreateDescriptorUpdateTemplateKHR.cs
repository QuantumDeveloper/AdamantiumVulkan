...
{
    public PFN_vkCreateDescriptorUpdateTemplateKHR(nuint ptr) : this((void*) ptr) { }
    ...
    public static explicit operator PFN_vkCreateDescriptorUpdateTemplateKHR(nuint ptr) => new(ptr);
}
