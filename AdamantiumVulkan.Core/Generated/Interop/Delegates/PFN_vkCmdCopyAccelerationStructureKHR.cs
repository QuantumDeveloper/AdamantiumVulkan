...
public unsafe struct PFN_vkCmdCopyAccelerationStructureKHR
{
    ...
    public static void Invoke(nuint ptr, AdamantiumVulkan.Core.Interop.VkCommandBuffer_T commandBuffer, AdamantiumVulkan.Core.Interop.VkCopyAccelerationStructureInfoKHR* pInfo)
    {
         ((delegate* unmanaged<AdamantiumVulkan.Core.Interop.VkCommandBuffer_T, AdamantiumVulkan.Core.Interop.VkCopyAccelerationStructureInfoKHR*, void>)(void*)ptr)(commandBuffer, pInfo);
    }
