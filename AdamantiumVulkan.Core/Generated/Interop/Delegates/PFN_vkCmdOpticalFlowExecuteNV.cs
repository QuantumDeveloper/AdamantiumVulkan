...
public unsafe struct PFN_vkCmdOpticalFlowExecuteNV
{
    ...
    public static void Invoke(nuint ptr, AdamantiumVulkan.Core.Interop.VkCommandBuffer_T commandBuffer, AdamantiumVulkan.Core.Interop.VkOpticalFlowSessionNV_T session, AdamantiumVulkan.Core.Interop.VkOpticalFlowExecuteInfoNV* pExecuteInfo)
    {
         ((delegate* unmanaged<AdamantiumVulkan.Core.Interop.VkCommandBuffer_T, AdamantiumVulkan.Core.Interop.VkOpticalFlowSessionNV_T, AdamantiumVulkan.Core.Interop.VkOpticalFlowExecuteInfoNV*, void>)(void*)ptr)(commandBuffer, session, pExecuteInfo);
    }
