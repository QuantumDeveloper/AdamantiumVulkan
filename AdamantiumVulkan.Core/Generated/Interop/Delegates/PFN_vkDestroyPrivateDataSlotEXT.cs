...
public unsafe struct PFN_vkDestroyPrivateDataSlotEXT
{
    public PFN_vkDestroyPrivateDataSlotEXT(nuint ptr) : this((void*) ptr) { }

    public PFN_vkDestroyPrivateDataSlotEXT(void* ptr)
    {
        NativePointer = ptr;
    ...
    public static void Invoke(nuint ptr, AdamantiumVulkan.Core.Interop.VkDevice_T device, AdamantiumVulkan.Core.Interop.VkPrivateDataSlot_T privateDataSlot, AdamantiumVulkan.Core.Interop.VkAllocationCallbacks* pAllocator)
    {
         ((delegate* unmanaged<AdamantiumVulkan.Core.Interop.VkDevice_T, AdamantiumVulkan.Core.Interop.VkPrivateDataSlot_T, AdamantiumVulkan.Core.Interop.VkAllocationCallbacks*, void>)(void*)ptr)(device, privateDataSlot, pAllocator);
    }

    public static explicit operator PFN_vkDestroyPrivateDataSlotEXT(void* ptr) => new(ptr);

    public static explicit operator PFN_vkDestroyPrivateDataSlotEXT(nuint ptr) => new(ptr);
}
