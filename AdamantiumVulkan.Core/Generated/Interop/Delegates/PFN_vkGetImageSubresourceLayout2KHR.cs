...
{
    public PFN_vkGetImageSubresourceLayout2KHR(nuint ptr) : this((void*) ptr) { }
    ...
    public static explicit operator PFN_vkGetImageSubresourceLayout2KHR(nuint ptr) => new(ptr);
}
