...
{
    public PFN_vkGetDeviceImageSparseMemoryRequirementsKHR(nuint ptr) : this((void*) ptr) { }
    ...
    public static explicit operator PFN_vkGetDeviceImageSparseMemoryRequirementsKHR(nuint ptr) => new(ptr);
}
