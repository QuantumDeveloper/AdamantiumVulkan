...
public unsafe struct PFN_vkCmdSetTessellationDomainOriginEXT
{
    ...
    public static void Invoke(nuint ptr, AdamantiumVulkan.Core.Interop.VkCommandBuffer_T commandBuffer, TessellationDomainOrigin domainOrigin)
    {
         ((delegate* unmanaged<AdamantiumVulkan.Core.Interop.VkCommandBuffer_T, TessellationDomainOrigin, void>)(void*)ptr)(commandBuffer, domainOrigin);
    }
