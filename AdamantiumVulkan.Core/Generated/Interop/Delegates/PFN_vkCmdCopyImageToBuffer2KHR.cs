...
{
    public PFN_vkCmdCopyImageToBuffer2KHR(nuint ptr) : this((void*) ptr) { }
    ...
    public static void Invoke(nuint ptr, AdamantiumVulkan.Core.Interop.VkCommandBuffer_T commandBuffer, AdamantiumVulkan.Core.Interop.VkCopyImageToBufferInfo2* pCopyImageToBufferInfo)
    {
         ((delegate* unmanaged<AdamantiumVulkan.Core.Interop.VkCommandBuffer_T, AdamantiumVulkan.Core.Interop.VkCopyImageToBufferInfo2*, void>)(void*)ptr)(commandBuffer, pCopyImageToBufferInfo);
    }

    public static explicit operator PFN_vkCmdCopyImageToBuffer2KHR(void* ptr) => new(ptr);

    public static explicit operator PFN_vkCmdCopyImageToBuffer2KHR(nuint ptr) => new(ptr);
}
