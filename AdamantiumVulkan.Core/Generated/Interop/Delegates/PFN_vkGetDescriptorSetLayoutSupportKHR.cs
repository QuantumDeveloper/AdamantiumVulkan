...
{
    public PFN_vkGetDescriptorSetLayoutSupportKHR(nuint ptr) : this((void*) ptr) { }
    ...
    public static explicit operator PFN_vkGetDescriptorSetLayoutSupportKHR(nuint ptr) => new(ptr);
}
