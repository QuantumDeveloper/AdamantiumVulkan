...
{
    public PFN_vkCmdBeginRenderPass2KHR(nuint ptr) : this((void*) ptr) { }
    ...
    public static void Invoke(nuint ptr, AdamantiumVulkan.Core.Interop.VkCommandBuffer_T commandBuffer, AdamantiumVulkan.Core.Interop.VkRenderPassBeginInfo* pRenderPassBegin, AdamantiumVulkan.Core.Interop.VkSubpassBeginInfo* pSubpassBeginInfo)
    {
         ((delegate* unmanaged<AdamantiumVulkan.Core.Interop.VkCommandBuffer_T, AdamantiumVulkan.Core.Interop.VkRenderPassBeginInfo*, AdamantiumVulkan.Core.Interop.VkSubpassBeginInfo*, void>)(void*)ptr)(commandBuffer, pRenderPassBegin, pSubpassBeginInfo);
    }

    public static explicit operator PFN_vkCmdBeginRenderPass2KHR(void* ptr) => new(ptr);

    public static explicit operator PFN_vkCmdBeginRenderPass2KHR(nuint ptr) => new(ptr);
}
