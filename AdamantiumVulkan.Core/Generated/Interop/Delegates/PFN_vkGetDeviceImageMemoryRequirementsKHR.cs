...
{
    public PFN_vkGetDeviceImageMemoryRequirementsKHR(nuint ptr) : this((void*) ptr) { }
    ...
    public static explicit operator PFN_vkGetDeviceImageMemoryRequirementsKHR(nuint ptr) => new(ptr);
}
