...
{
    public PFN_vkGetPhysicalDeviceImageFormatProperties2KHR(nuint ptr) : this((void*) ptr) { }
    ...
    public static explicit operator PFN_vkGetPhysicalDeviceImageFormatProperties2KHR(nuint ptr) => new(ptr);
}
