...
public unsafe struct PFN_vkGetPhysicalDeviceVideoCapabilitiesKHR
{
    ...
    public static Result Invoke(nuint ptr, AdamantiumVulkan.Core.Interop.VkPhysicalDevice_T physicalDevice, AdamantiumVulkan.Core.Interop.VkVideoProfileInfoKHR* pVideoProfile, AdamantiumVulkan.Core.Interop.VkVideoCapabilitiesKHR* pCapabilities)
    {
        return ((delegate* unmanaged<AdamantiumVulkan.Core.Interop.VkPhysicalDevice_T, AdamantiumVulkan.Core.Interop.VkVideoProfileInfoKHR*, AdamantiumVulkan.Core.Interop.VkVideoCapabilitiesKHR*, Result>)(void*)ptr)(physicalDevice, pVideoProfile, pCapabilities);
    }
