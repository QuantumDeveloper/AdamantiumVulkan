...
{
    public PFN_vkGetPhysicalDeviceExternalBufferPropertiesKHR(nuint ptr) : this((void*) ptr) { }
    ...
    public static explicit operator PFN_vkGetPhysicalDeviceExternalBufferPropertiesKHR(nuint ptr) => new(ptr);
}
