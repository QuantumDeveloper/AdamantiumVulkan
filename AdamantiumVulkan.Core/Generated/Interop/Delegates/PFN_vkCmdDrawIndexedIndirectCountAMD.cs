...
public unsafe struct PFN_vkCmdDrawIndexedIndirectCountAMD
{
    public PFN_vkCmdDrawIndexedIndirectCountAMD(nuint ptr) : this((void*) ptr) { }

    public PFN_vkCmdDrawIndexedIndirectCountAMD(void* ptr)
    {
        NativePointer = ptr;
    ...
    public static explicit operator PFN_vkCmdDrawIndexedIndirectCountAMD(void* ptr) => new(ptr);

    public static explicit operator PFN_vkCmdDrawIndexedIndirectCountAMD(nuint ptr) => new(ptr);
}
