...
public unsafe struct PFN_vkCmdDrawIndirectCountAMD
{
    public PFN_vkCmdDrawIndirectCountAMD(nuint ptr) : this((void*) ptr) { }

    public PFN_vkCmdDrawIndirectCountAMD(void* ptr)
    {
        NativePointer = ptr;
    ...
    public static explicit operator PFN_vkCmdDrawIndirectCountAMD(void* ptr) => new(ptr);

    public static explicit operator PFN_vkCmdDrawIndirectCountAMD(nuint ptr) => new(ptr);
}
