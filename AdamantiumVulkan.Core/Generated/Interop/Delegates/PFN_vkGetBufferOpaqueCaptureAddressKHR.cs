...
{
    public PFN_vkGetBufferOpaqueCaptureAddressKHR(nuint ptr) : this((void*) ptr) { }
    ...
    public static explicit operator PFN_vkGetBufferOpaqueCaptureAddressKHR(nuint ptr) => new(ptr);
}
