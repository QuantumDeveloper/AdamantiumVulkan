...
{
    public PFN_vkGetBufferMemoryRequirements2KHR(nuint ptr) : this((void*) ptr) { }
    ...
    public static explicit operator PFN_vkGetBufferMemoryRequirements2KHR(nuint ptr) => new(ptr);
}
