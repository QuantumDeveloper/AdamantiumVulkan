...
{
    public PFN_vkGetPhysicalDeviceSparseImageFormatProperties2KHR(nuint ptr) : this((void*) ptr) { }
    ...
    public static explicit operator PFN_vkGetPhysicalDeviceSparseImageFormatProperties2KHR(nuint ptr) => new(ptr);
}
