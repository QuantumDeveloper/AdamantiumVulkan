...
public unsafe struct PFN_vkCmdSetCullModeEXT
{
    public PFN_vkCmdSetCullModeEXT(nuint ptr) : this((void*) ptr) { }

    public PFN_vkCmdSetCullModeEXT(void* ptr)
    {
        NativePointer = ptr;
    ...
    public static explicit operator PFN_vkCmdSetCullModeEXT(void* ptr) => new(ptr);

    public static explicit operator PFN_vkCmdSetCullModeEXT(nuint ptr) => new(ptr);
}
