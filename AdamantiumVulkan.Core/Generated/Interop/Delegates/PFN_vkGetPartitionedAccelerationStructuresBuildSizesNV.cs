...
public unsafe struct PFN_vkGetPartitionedAccelerationStructuresBuildSizesNV
{
    ...
    {
        NativePointer = ptr;
        InvokeFunc = (delegate* unmanaged<AdamantiumVulkan.Core.Interop.VkDevice_T, AdamantiumVulkan.Core.Interop.VkPartitionedAccelerationStructureInstancesInputNV*, AdamantiumVulkan.Core.Interop.VkAccelerationStructureBuildSizesInfoKHR*, void>)ptr;
    }

    private delegate* unmanaged<AdamantiumVulkan.Core.Interop.VkDevice_T, AdamantiumVulkan.Core.Interop.VkPartitionedAccelerationStructureInstancesInputNV*, AdamantiumVulkan.Core.Interop.VkAccelerationStructureBuildSizesInfoKHR*, void> InvokeFunc;

    public void* NativePointer { get; }

    public void Invoke(AdamantiumVulkan.Core.Interop.VkDevice_T device, AdamantiumVulkan.Core.Interop.VkPartitionedAccelerationStructureInstancesInputNV* pInfo, AdamantiumVulkan.Core.Interop.VkAccelerationStructureBuildSizesInfoKHR* pSizeInfo)
    {
         InvokeFunc(device, pInfo, pSizeInfo);
    }
    public static void Invoke(void* ptr, AdamantiumVulkan.Core.Interop.VkDevice_T device, AdamantiumVulkan.Core.Interop.VkPartitionedAccelerationStructureInstancesInputNV* pInfo, AdamantiumVulkan.Core.Interop.VkAccelerationStructureBuildSizesInfoKHR* pSizeInfo)
    {
