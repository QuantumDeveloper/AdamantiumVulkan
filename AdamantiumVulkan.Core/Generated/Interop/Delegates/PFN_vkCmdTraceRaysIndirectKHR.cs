...
public unsafe struct PFN_vkCmdTraceRaysIndirectKHR
{
    ...
    {
         ((delegate* unmanaged<AdamantiumVulkan.Core.Interop.VkCommandBuffer_T, AdamantiumVulkan.Core.Interop.VkStridedDeviceAddressRegionKHR*, AdamantiumVulkan.Core.Interop.VkStridedDeviceAddressRegionKHR*, AdamantiumVulkan.Core.Interop.VkStridedDeviceAddressRegionKHR*, AdamantiumVulkan.Core.Interop.VkStridedDeviceAddressRegionKHR*, VkDeviceAddress, void>)(void*)ptr)(commandBuffer, pRaygenShaderBindingTable, pMissShaderBindingTable, pHitShaderBindingTable, pCallableShaderBindingTable, indirectDeviceAddress);
    }
