...
public unsafe partial class CopyImageToImageInfo : QBDisposableObject
{
    ...
    public CopyImageToImageInfo(AdamantiumVulkan.Core.Interop.VkCopyImageToImageInfo _internal)
    {
    ...
    public AdamantiumVulkan.Core.Interop.VkCopyImageToImageInfo ToNative()
    {
        var _internal = new AdamantiumVulkan.Core.Interop.VkCopyImageToImageInfo();
        if (SType != default)
        {
    ...
    {
        return new CopyImageToImageInfo(c);
    }
