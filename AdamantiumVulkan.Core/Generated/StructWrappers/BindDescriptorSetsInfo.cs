...
public unsafe partial class BindDescriptorSetsInfo : QBDisposableObject
{
    ...
    public BindDescriptorSetsInfo(AdamantiumVulkan.Core.Interop.VkBindDescriptorSetsInfo _internal)
    {
    ...
    public AdamantiumVulkan.Core.Interop.VkBindDescriptorSetsInfo ToNative()
    {
        var _internal = new AdamantiumVulkan.Core.Interop.VkBindDescriptorSetsInfo();
        if (SType != default)
        {
    ...
    {
        return new BindDescriptorSetsInfo(b);
    }
