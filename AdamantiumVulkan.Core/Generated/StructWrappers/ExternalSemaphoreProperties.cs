...
public unsafe partial class ExternalSemaphoreProperties : IMarshallableObject, IMarshallable<AdamantiumVulkan.Core.Interop.VkExternalSemaphoreProperties>
{
    public ExternalSemaphoreProperties()
    {
    }

    public ExternalSemaphoreProperties(in AdamantiumVulkan.Core.Interop.VkExternalSemaphoreProperties native)
    {
    ...
    public int GetSize()
    {
        var size = Marshal.SizeOf<AdamantiumVulkan.Core.Interop.VkExternalSemaphoreProperties>();
    ...
    public void MarshalTo(ref MarshallingContext<AdamantiumVulkan.Core.Interop.VkExternalSemaphoreProperties> context)
    {
        new VkExternalSemaphorePropertiesMarshaller(this, ref context);
    }

    public void MarshalFrom(in AdamantiumVulkan.Core.Interop.VkExternalSemaphoreProperties native)
    {
    ...
    {
        public VkExternalSemaphorePropertiesMarshaller(AdamantiumVulkan.Core.ExternalSemaphoreProperties externalSemaphoreProperties, ref QuantumBinding.Utils.MarshallingContext<AdamantiumVulkan.Core.Interop.VkExternalSemaphoreProperties> context)
        {
