...
public unsafe partial class SurfacePresentModeCompatibilityEXT : QBDisposableObject
{
    ...
    public SurfacePresentModeCompatibilityEXT(AdamantiumVulkan.Core.Interop.VkSurfacePresentModeCompatibilityEXT _internal)
    {
    ...
    public AdamantiumVulkan.Core.Interop.VkSurfacePresentModeCompatibilityEXT ToNative()
    {
        var _internal = new AdamantiumVulkan.Core.Interop.VkSurfacePresentModeCompatibilityEXT();
        if (SType != default)
        {
    ...
    {
        return new SurfacePresentModeCompatibilityEXT(s);
    }
