...
public unsafe partial class VertexInputBindingDivisorDescriptionKHR : QBDisposableObject
{
    ...
    public VertexInputBindingDivisorDescriptionKHR(AdamantiumVulkan.Core.Interop.VkVertexInputBindingDivisorDescriptionKHR _internal)
    {
    ...
    public static implicit operator VertexInputBindingDivisorDescriptionKHR(AdamantiumVulkan.Core.Interop.VkVertexInputBindingDivisorDescriptionKHR v)
    {
        return new VertexInputBindingDivisorDescriptionKHR(v);
    }
