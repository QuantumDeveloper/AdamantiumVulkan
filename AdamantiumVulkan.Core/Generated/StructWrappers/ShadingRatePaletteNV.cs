...
public unsafe partial class ShadingRatePaletteNV : IMarshallableObject, IMarshallable<AdamantiumVulkan.Core.Interop.VkShadingRatePaletteNV>
{
    public ShadingRatePaletteNV()
    {
    }

    public ShadingRatePaletteNV(in AdamantiumVulkan.Core.Interop.VkShadingRatePaletteNV native)
    {
    ...
    public void MarshalTo(ref MarshallingContext<AdamantiumVulkan.Core.Interop.VkShadingRatePaletteNV> context)
    {
    ...
    {
        public VkShadingRatePaletteNVMarshaller(AdamantiumVulkan.Core.ShadingRatePaletteNV shadingRatePaletteNV, ref QuantumBinding.Utils.MarshallingContext<AdamantiumVulkan.Core.Interop.VkShadingRatePaletteNV> context)
        {
