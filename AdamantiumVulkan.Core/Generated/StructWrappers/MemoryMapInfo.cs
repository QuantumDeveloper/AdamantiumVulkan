...
public unsafe partial class MemoryMapInfo : QBDisposableObject
{
    public MemoryMapInfo()
    {
    }

    public MemoryMapInfo(AdamantiumVulkan.Core.Interop.VkMemoryMapInfo _internal)
    {
    ...
    public AdamantiumVulkan.Core.Interop.VkMemoryMapInfo ToNative()
    {
        var _internal = new AdamantiumVulkan.Core.Interop.VkMemoryMapInfo();
        if (SType != default)
        {
