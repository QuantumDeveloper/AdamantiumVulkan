...
public unsafe partial class PhysicalDeviceLineRasterizationFeaturesKHR : QBDisposableObject
{
    public PhysicalDeviceLineRasterizationFeaturesKHR()
    {
    }

    public PhysicalDeviceLineRasterizationFeaturesKHR(AdamantiumVulkan.Core.Interop.VkPhysicalDeviceLineRasterizationFeaturesKHR _internal)
    {
    ...
    public AdamantiumVulkan.Core.Interop.VkPhysicalDeviceLineRasterizationFeaturesKHR ToNative()
    {
        var _internal = new AdamantiumVulkan.Core.Interop.VkPhysicalDeviceLineRasterizationFeaturesKHR();
        if (SType != default)
        {
    ...
    public static implicit operator PhysicalDeviceLineRasterizationFeaturesKHR(AdamantiumVulkan.Core.Interop.VkPhysicalDeviceLineRasterizationFeaturesKHR p)
    {
        return new PhysicalDeviceLineRasterizationFeaturesKHR(p);
    }
