...
public unsafe partial class RenderingAreaInfo : QBDisposableObject
{
    ...
    public RenderingAreaInfo(AdamantiumVulkan.Core.Interop.VkRenderingAreaInfo _internal)
    {
    ...
    public AdamantiumVulkan.Core.Interop.VkRenderingAreaInfo ToNative()
    {
        var _internal = new AdamantiumVulkan.Core.Interop.VkRenderingAreaInfo();
        if (SType != default)
        {
    ...
    {
        return new RenderingAreaInfo(r);
    }
