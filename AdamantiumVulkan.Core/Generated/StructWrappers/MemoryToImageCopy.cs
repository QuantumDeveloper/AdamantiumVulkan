...
public unsafe partial class MemoryToImageCopy : QBDisposableObject
{
    public MemoryToImageCopy()
    {
    }

    public MemoryToImageCopy(AdamantiumVulkan.Core.Interop.VkMemoryToImageCopy _internal)
    {
    ...
    public AdamantiumVulkan.Core.Interop.VkMemoryToImageCopy ToNative()
    {
        var _internal = new AdamantiumVulkan.Core.Interop.VkMemoryToImageCopy();
        if (SType != default)
        {
    ...
    {
        return new MemoryToImageCopy(m);
    }
