...
public unsafe partial class DeviceImageSubresourceInfoKHR : QBDisposableObject
{
    private NativeStruct<AdamantiumVulkan.Core.Interop.VkImageCreateInfo> _pCreateInfo;

    private NativeStruct<AdamantiumVulkan.Core.Interop.VkImageSubresource2KHR> _pSubresource;

    public DeviceImageSubresourceInfoKHR()
    {
    }

    public DeviceImageSubresourceInfoKHR(AdamantiumVulkan.Core.Interop.VkDeviceImageSubresourceInfoKHR _internal)
    {
        SType = _internal.sType;
        PNext = _internal.pNext;
        PCreateInfo = new ImageCreateInfo(*_internal.pCreateInfo);
        NativeUtils.Free(_internal.pCreateInfo);
        PSubresource = new ImageSubresource2KHR(*_internal.pSubresource);
    ...
    public ImageSubresource2KHR PSubresource { get; set; }
    ...
    public static implicit operator DeviceImageSubresourceInfoKHR(AdamantiumVulkan.Core.Interop.VkDeviceImageSubresourceInfoKHR d)
    {
        return new DeviceImageSubresourceInfoKHR(d);
    }
