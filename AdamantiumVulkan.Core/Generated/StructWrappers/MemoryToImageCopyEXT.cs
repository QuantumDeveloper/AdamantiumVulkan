...
public unsafe partial class MemoryToImageCopyEXT : QBDisposableObject
{
    public MemoryToImageCopyEXT()
    {
    }

    public MemoryToImageCopyEXT(AdamantiumVulkan.Core.Interop.VkMemoryToImageCopyEXT _internal)
    {
    ...
    {
        return new MemoryToImageCopyEXT(m);
    }
