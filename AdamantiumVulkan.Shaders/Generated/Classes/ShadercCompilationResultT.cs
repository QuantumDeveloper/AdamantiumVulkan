...
// File: C:\VulkanSDK\1.4.309.0\Include\shaderc\shaderc.h Line: 511 Column: 44
///<summary>
/// An opaque handle to the results of a call to any shaderc_compile_into_*() function.
///</summary>
public unsafe partial class ShadercCompilationResultT : IUnmanagedWrapper<AdamantiumVulkan.Shaders.Interop.ShadercCompilationResult>
{
    ...
    public ShadercCompilationResultT(in AdamantiumVulkan.Shaders.Interop.ShadercCompilationResult __Instance)
    {
        this.__Instance = __Instance;
    }

    public AdamantiumVulkan.Shaders.Interop.ShadercCompilationResult GetNativeValue() => __Instance;
    ///<summary>
    ...
    {
        return new ShadercCompilationResultT(in s);
    }
