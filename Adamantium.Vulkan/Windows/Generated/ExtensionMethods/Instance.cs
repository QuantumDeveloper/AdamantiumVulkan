...
public static unsafe partial class InstanceExtension
{
    ...
    {
        int CalculateSize(Win32SurfaceCreateInfoKHR pCreateInfo, AllocationCallbacks pAllocator)
        {
            int totalSize = 0;
            if (pCreateInfo != null)
        ...
        fixed (byte* bufferPtr = mainBuffer)
        {
            try
            {
                ...
                var arg1 = QuantumBinding.Utils.MarshalContextUtils.MarshalStructToPointer<Adamantium.Vulkan.Windows.Win32SurfaceCreateInfoKHR, Adamantium.Vulkan.Windows.Interop.VkWin32SurfaceCreateInfoKHR>(pCreateInfo, ref currentCursor);
                ...
                var result = instance.Commands.vkCreateWin32SurfaceKHR(instance, arg1, arg2, &arg3);
