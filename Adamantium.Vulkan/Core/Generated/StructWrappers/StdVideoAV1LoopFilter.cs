...
public unsafe partial class StdVideoAV1LoopFilter : IMarshallableObject, IMarshallableFromPointer, IMarshallable<Adamantium.Vulkan.Core.Interop.StdVideoAV1LoopFilter>
{
    public StdVideoAV1LoopFilter()
    {
    }

    public StdVideoAV1LoopFilter(in Adamantium.Vulkan.Core.Interop.StdVideoAV1LoopFilter native)
    {
    ...
    public static implicit operator StdVideoAV1LoopFilter(Adamantium.Vulkan.Core.Interop.StdVideoAV1LoopFilter s)
    {
    ...
    public int GetSize()
    {
        var size = QuantumBinding.Utils.SizeOfCache<Adamantium.Vulkan.Core.Interop.StdVideoAV1LoopFilter>.Size;
        return size;
    }

    public void MarshalTo(ref MarshallingContext<Adamantium.Vulkan.Core.Interop.StdVideoAV1LoopFilter> context)
    {
        new StdVideoAV1LoopFilterMarshaller(this, ref context);
    }

    public void MarshalFrom(in Adamantium.Vulkan.Core.Interop.StdVideoAV1LoopFilter native)
    {
    ...
    {
        var nativeSpan = context.AllocateNative<Adamantium.Vulkan.Core.Interop.StdVideoAV1LoopFilter>(1);
        var dataCursor = context.GetDataCursor();
        var internalContext = new MarshallingContext<Adamantium.Vulkan.Core.Interop.StdVideoAV1LoopFilter>(nativeSpan, dataCursor);
    ...
    public void MarshalFromPointer(void* native)
    {
        ...
        MarshalFrom(in *(Adamantium.Vulkan.Core.Interop.StdVideoAV1LoopFilter*)native);
    }
    private ref struct StdVideoAV1LoopFilterMarshaller
    {
        public StdVideoAV1LoopFilterMarshaller(Adamantium.Vulkan.Core.StdVideoAV1LoopFilter stdVideoAV1LoopFilter, ref QuantumBinding.Utils.MarshallingContext<Adamantium.Vulkan.Core.Interop.StdVideoAV1LoopFilter> context)
        {
            if (stdVideoAV1LoopFilter.Flags != default)
            {
                fixed (Adamantium.Vulkan.Core.Interop.StdVideoAV1LoopFilterFlags* pField = &context.Destination[0].flags)
                {
                    var fieldSpan = new System.Span<Adamantium.Vulkan.Core.Interop.StdVideoAV1LoopFilterFlags>(pField, 1);
                    var childContext = new MarshallingContext<Adamantium.Vulkan.Core.Interop.StdVideoAV1LoopFilterFlags>(fieldSpan, context.DataCursor);
