...
public unsafe partial class SubpassDescription2 : IMarshallableObject, IMarshallableFromPointer, IMarshallable<Adamantium.Vulkan.Core.Interop.VkSubpassDescription2>
{
    public SubpassDescription2()
    {
    }

    public SubpassDescription2(in Adamantium.Vulkan.Core.Interop.VkSubpassDescription2 native)
    {
    ...
    public static implicit operator SubpassDescription2(Adamantium.Vulkan.Core.Interop.VkSubpassDescription2 s)
    {
    ...
    public void MarshalTo(ref MarshallingContext<Adamantium.Vulkan.Core.Interop.VkSubpassDescription2> context)
    {
        new VkSubpassDescription2Marshaller(this, ref context);
    }

    public void MarshalFrom(in Adamantium.Vulkan.Core.Interop.VkSubpassDescription2 native)
    {
        ...
        var nativeTmpArray0 = new Adamantium.Vulkan.Core.Interop.VkAttachmentReference2[arrayLengthPInputAttachments];
        ...
        var nativeTmpArray1 = new Adamantium.Vulkan.Core.Interop.VkAttachmentReference2[arrayLengthPColorAttachments];
        ...
        var nativeTmpArray2 = new Adamantium.Vulkan.Core.Interop.VkAttachmentReference2[arrayLengthPResolveAttachments];
    ...
    {
        var nativeSpan = context.AllocateNative<Adamantium.Vulkan.Core.Interop.VkSubpassDescription2>(1);
        var dataCursor = context.GetDataCursor();
        var internalContext = new MarshallingContext<Adamantium.Vulkan.Core.Interop.VkSubpassDescription2>(nativeSpan, dataCursor);
    ...
    public void MarshalFromPointer(void* native)
    {
        ...
        MarshalFrom(in *(Adamantium.Vulkan.Core.Interop.VkSubpassDescription2*)native);
    }
    private ref struct VkSubpassDescription2Marshaller
    {
        public VkSubpassDescription2Marshaller(Adamantium.Vulkan.Core.SubpassDescription2 subpassDescription2, ref QuantumBinding.Utils.MarshallingContext<Adamantium.Vulkan.Core.Interop.VkSubpassDescription2> context)
        {
            ...
            {
                context.Destination[0].pInputAttachments = QuantumBinding.Utils.MarshalingUtils.MarshalArrayToPointer<Adamantium.Vulkan.Core.AttachmentReference2, Adamantium.Vulkan.Core.Interop.VkAttachmentReference2, Adamantium.Vulkan.Core.Interop.VkSubpassDescription2>(subpassDescription2.PInputAttachments, ref context);
            }
            ...
            {
                context.Destination[0].pColorAttachments = QuantumBinding.Utils.MarshalingUtils.MarshalArrayToPointer<Adamantium.Vulkan.Core.AttachmentReference2, Adamantium.Vulkan.Core.Interop.VkAttachmentReference2, Adamantium.Vulkan.Core.Interop.VkSubpassDescription2>(subpassDescription2.PColorAttachments, ref context);
            }

            if (!subpassDescription2.PResolveAttachments.IsEmpty)
            {
                context.Destination[0].pResolveAttachments = QuantumBinding.Utils.MarshalingUtils.MarshalArrayToPointer<Adamantium.Vulkan.Core.AttachmentReference2, Adamantium.Vulkan.Core.Interop.VkAttachmentReference2, Adamantium.Vulkan.Core.Interop.VkSubpassDescription2>(subpassDescription2.PResolveAttachments, ref context);
            }
            ...
            if (subpassDescription2.PDepthStencilAttachment != default)
            {
                ...
                context.Destination[0].pDepthStencilAttachment = (Adamantium.Vulkan.Core.Interop.VkAttachmentReference2*)System.Runtime.CompilerServices.Unsafe.AsPointer(ref structDestination0[0]);
            ...
            {
                context.Destination[0].pPreserveAttachments = QuantumBinding.Utils.MarshalingUtils.MarshalBlittableArrayToPointer<uint, Adamantium.Vulkan.Core.Interop.VkSubpassDescription2>(subpassDescription2.PreserveAttachments.Span, ref context);
            }
