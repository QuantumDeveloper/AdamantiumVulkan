...
public unsafe partial class SubmitInfo2 : IMarshallableObject, IMarshallableFromPointer, IMarshallable<Adamantium.Vulkan.Core.Interop.VkSubmitInfo2>
{
    ...
    public SubmitInfo2(in Adamantium.Vulkan.Core.Interop.VkSubmitInfo2 native)
    {
    ...
    public static implicit operator SubmitInfo2(Adamantium.Vulkan.Core.Interop.VkSubmitInfo2 s)
    {
    ...
    public void MarshalTo(ref MarshallingContext<Adamantium.Vulkan.Core.Interop.VkSubmitInfo2> context)
    {
    ...
    public void MarshalFrom(in Adamantium.Vulkan.Core.Interop.VkSubmitInfo2 native)
    {
        ...
        var nativeTmpArray0 = new Adamantium.Vulkan.Core.Interop.VkSemaphoreSubmitInfo[arrayLengthPWaitSemaphoreInfos];
        ...
        var nativeTmpArray1 = new Adamantium.Vulkan.Core.Interop.VkCommandBufferSubmitInfo[arrayLengthPCommandBufferInfos];
        ...
        var nativeTmpArray2 = new Adamantium.Vulkan.Core.Interop.VkSemaphoreSubmitInfo[arrayLengthPSignalSemaphoreInfos];
    ...
    {
        var nativeSpan = context.AllocateNative<Adamantium.Vulkan.Core.Interop.VkSubmitInfo2>(1);
        var dataCursor = context.GetDataCursor();
        var internalContext = new MarshallingContext<Adamantium.Vulkan.Core.Interop.VkSubmitInfo2>(nativeSpan, dataCursor);
    ...
    {
        public VkSubmitInfo2Marshaller(Adamantium.Vulkan.Core.SubmitInfo2 submitInfo2, ref QuantumBinding.Utils.MarshallingContext<Adamantium.Vulkan.Core.Interop.VkSubmitInfo2> context)
        {
            ...
            {
                context.Destination[0].pWaitSemaphoreInfos = QuantumBinding.Utils.MarshalingUtils.MarshalArrayToPointer<Adamantium.Vulkan.Core.SemaphoreSubmitInfo, Adamantium.Vulkan.Core.Interop.VkSemaphoreSubmitInfo, Adamantium.Vulkan.Core.Interop.VkSubmitInfo2>(submitInfo2.PWaitSemaphoreInfos, ref context);
            }
            ...
            {
                context.Destination[0].pCommandBufferInfos = QuantumBinding.Utils.MarshalingUtils.MarshalArrayToPointer<Adamantium.Vulkan.Core.CommandBufferSubmitInfo, Adamantium.Vulkan.Core.Interop.VkCommandBufferSubmitInfo, Adamantium.Vulkan.Core.Interop.VkSubmitInfo2>(submitInfo2.PCommandBufferInfos, ref context);
            }
            ...
            {
                context.Destination[0].pSignalSemaphoreInfos = QuantumBinding.Utils.MarshalingUtils.MarshalArrayToPointer<Adamantium.Vulkan.Core.SemaphoreSubmitInfo, Adamantium.Vulkan.Core.Interop.VkSemaphoreSubmitInfo, Adamantium.Vulkan.Core.Interop.VkSubmitInfo2>(submitInfo2.PSignalSemaphoreInfos, ref context);
            }
