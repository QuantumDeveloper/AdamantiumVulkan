...
public unsafe partial class StdVideoAV1FilmGrain : IMarshallableObject, IMarshallableFromPointer, IMarshallable<Adamantium.Vulkan.Core.Interop.StdVideoAV1FilmGrain>
{
    public StdVideoAV1FilmGrain()
    {
    }

    public StdVideoAV1FilmGrain(in Adamantium.Vulkan.Core.Interop.StdVideoAV1FilmGrain native)
    {
    ...
    public static implicit operator StdVideoAV1FilmGrain(Adamantium.Vulkan.Core.Interop.StdVideoAV1FilmGrain s)
    {
    ...
    public void MarshalTo(ref MarshallingContext<Adamantium.Vulkan.Core.Interop.StdVideoAV1FilmGrain> context)
    {
        new StdVideoAV1FilmGrainMarshaller(this, ref context);
    }

    public void MarshalFrom(in Adamantium.Vulkan.Core.Interop.StdVideoAV1FilmGrain native)
    {
    ...
    {
        var nativeSpan = context.AllocateNative<Adamantium.Vulkan.Core.Interop.StdVideoAV1FilmGrain>(1);
        var dataCursor = context.GetDataCursor();
        var internalContext = new MarshallingContext<Adamantium.Vulkan.Core.Interop.StdVideoAV1FilmGrain>(nativeSpan, dataCursor);
    ...
    public void MarshalFromPointer(void* native)
    {
        ...
        MarshalFrom(in *(Adamantium.Vulkan.Core.Interop.StdVideoAV1FilmGrain*)native);
    }
    private ref struct StdVideoAV1FilmGrainMarshaller
    {
        public StdVideoAV1FilmGrainMarshaller(Adamantium.Vulkan.Core.StdVideoAV1FilmGrain stdVideoAV1FilmGrain, ref QuantumBinding.Utils.MarshallingContext<Adamantium.Vulkan.Core.Interop.StdVideoAV1FilmGrain> context)
        {
            if (stdVideoAV1FilmGrain.Flags != default)
            {
                fixed (Adamantium.Vulkan.Core.Interop.StdVideoAV1FilmGrainFlags* pField = &context.Destination[0].flags)
                {
                    var fieldSpan = new System.Span<Adamantium.Vulkan.Core.Interop.StdVideoAV1FilmGrainFlags>(pField, 1);
                    var childContext = new MarshallingContext<Adamantium.Vulkan.Core.Interop.StdVideoAV1FilmGrainFlags>(fieldSpan, context.DataCursor);
