...
public unsafe partial class RenderPassCreateInfo2 : IMarshallableObject, IMarshallable<Adamantium.Vulkan.Core.Interop.VkRenderPassCreateInfo2>
{
    ...
    public RenderPassCreateInfo2(in Adamantium.Vulkan.Core.Interop.VkRenderPassCreateInfo2 native)
    {
    ...
    public static implicit operator RenderPassCreateInfo2(Adamantium.Vulkan.Core.Interop.VkRenderPassCreateInfo2 r)
    {
    ...
    public void MarshalTo(ref MarshallingContext<Adamantium.Vulkan.Core.Interop.VkRenderPassCreateInfo2> context)
    {
    ...
    public void MarshalFrom(in Adamantium.Vulkan.Core.Interop.VkRenderPassCreateInfo2 native)
    {
        ...
        var nativeTmpArray0 = new Adamantium.Vulkan.Core.Interop.VkAttachmentDescription2[arrayLengthPAttachments];
        ...
        var nativeTmpArray1 = new Adamantium.Vulkan.Core.Interop.VkSubpassDescription2[arrayLengthPSubpasses];
        ...
        var nativeTmpArray2 = new Adamantium.Vulkan.Core.Interop.VkSubpassDependency2[arrayLengthPDependencies];
    ...
    {
        var nativeSpan = context.AllocateNative<Adamantium.Vulkan.Core.Interop.VkRenderPassCreateInfo2>(1);
        var dataCursor = context.GetDataCursor();
        var internalContext = new MarshallingContext<Adamantium.Vulkan.Core.Interop.VkRenderPassCreateInfo2>(nativeSpan, dataCursor);
    ...
    {
        public VkRenderPassCreateInfo2Marshaller(Adamantium.Vulkan.Core.RenderPassCreateInfo2 renderPassCreateInfo2, ref QuantumBinding.Utils.MarshallingContext<Adamantium.Vulkan.Core.Interop.VkRenderPassCreateInfo2> context)
        {
            ...
            {
                context.Destination[0].pAttachments = QuantumBinding.Utils.MarshalingUtils.MarshalArrayToPointer<Adamantium.Vulkan.Core.AttachmentDescription2, Adamantium.Vulkan.Core.Interop.VkAttachmentDescription2, Adamantium.Vulkan.Core.Interop.VkRenderPassCreateInfo2>(renderPassCreateInfo2.PAttachments, ref context);
            }
            ...
            {
                context.Destination[0].pSubpasses = QuantumBinding.Utils.MarshalingUtils.MarshalArrayToPointer<Adamantium.Vulkan.Core.SubpassDescription2, Adamantium.Vulkan.Core.Interop.VkSubpassDescription2, Adamantium.Vulkan.Core.Interop.VkRenderPassCreateInfo2>(renderPassCreateInfo2.PSubpasses, ref context);
            }
            ...
            {
                context.Destination[0].pDependencies = QuantumBinding.Utils.MarshalingUtils.MarshalArrayToPointer<Adamantium.Vulkan.Core.SubpassDependency2, Adamantium.Vulkan.Core.Interop.VkSubpassDependency2, Adamantium.Vulkan.Core.Interop.VkRenderPassCreateInfo2>(renderPassCreateInfo2.PDependencies, ref context);
            }
            ...
            {
                context.Destination[0].pCorrelatedViewMasks = QuantumBinding.Utils.MarshalingUtils.MarshalBlittableArrayToPointer<uint, Adamantium.Vulkan.Core.Interop.VkRenderPassCreateInfo2>(renderPassCreateInfo2.PCorrelatedViewMasks.Span, ref context);
            }
