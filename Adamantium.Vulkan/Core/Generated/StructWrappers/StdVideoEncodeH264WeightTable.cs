...
public unsafe partial class StdVideoEncodeH264WeightTable : IMarshallableObject, IMarshallable<Adamantium.Vulkan.Core.Interop.StdVideoEncodeH264WeightTable>
{
    ...
    public StdVideoEncodeH264WeightTable(in Adamantium.Vulkan.Core.Interop.StdVideoEncodeH264WeightTable native)
    {
    ...
    public static implicit operator StdVideoEncodeH264WeightTable(Adamantium.Vulkan.Core.Interop.StdVideoEncodeH264WeightTable s)
    {
    ...
    public int GetSize()
    {
        var size = QuantumBinding.Utils.SizeOfCache<Adamantium.Vulkan.Core.Interop.StdVideoEncodeH264WeightTable>.Size;
        return size;
    }

    public void MarshalTo(ref MarshallingContext<Adamantium.Vulkan.Core.Interop.StdVideoEncodeH264WeightTable> context)
    {
        new StdVideoEncodeH264WeightTableMarshaller(this, ref context);
    }

    public void MarshalFrom(in Adamantium.Vulkan.Core.Interop.StdVideoEncodeH264WeightTable native)
    {
    ...
    {
        var nativeSpan = context.AllocateNative<Adamantium.Vulkan.Core.Interop.StdVideoEncodeH264WeightTable>(1);
        var dataCursor = context.GetDataCursor();
        var internalContext = new MarshallingContext<Adamantium.Vulkan.Core.Interop.StdVideoEncodeH264WeightTable>(nativeSpan, dataCursor);
    ...
    {
        public StdVideoEncodeH264WeightTableMarshaller(Adamantium.Vulkan.Core.StdVideoEncodeH264WeightTable stdVideoEncodeH264WeightTable, ref QuantumBinding.Utils.MarshallingContext<Adamantium.Vulkan.Core.Interop.StdVideoEncodeH264WeightTable> context)
        {
            if (stdVideoEncodeH264WeightTable.Flags != default)
            {
                fixed (Adamantium.Vulkan.Core.Interop.StdVideoEncodeH264WeightTableFlags* pField = &context.Destination[0].flags)
                {
                    var fieldSpan = new System.Span<Adamantium.Vulkan.Core.Interop.StdVideoEncodeH264WeightTableFlags>(pField, 1);
                    var childContext = new MarshallingContext<Adamantium.Vulkan.Core.Interop.StdVideoEncodeH264WeightTableFlags>(fieldSpan, context.DataCursor);
