...
public unsafe partial class PhysicalDeviceClusterCullingShaderPropertiesHUAWEI : IMarshallableObject, IMarshallableFromPointer, IMarshallable<Adamantium.Vulkan.Core.Interop.VkPhysicalDeviceClusterCullingShaderPropertiesHUAWEI>
{
    ...
    public PhysicalDeviceClusterCullingShaderPropertiesHUAWEI(in Adamantium.Vulkan.Core.Interop.VkPhysicalDeviceClusterCullingShaderPropertiesHUAWEI native)
    {
    ...
    public static implicit operator PhysicalDeviceClusterCullingShaderPropertiesHUAWEI(Adamantium.Vulkan.Core.Interop.VkPhysicalDeviceClusterCullingShaderPropertiesHUAWEI p)
    {
    ...
    public void MarshalTo(ref MarshallingContext<Adamantium.Vulkan.Core.Interop.VkPhysicalDeviceClusterCullingShaderPropertiesHUAWEI> context)
    {
    ...
    {
        var nativeSpan = context.AllocateNative<Adamantium.Vulkan.Core.Interop.VkPhysicalDeviceClusterCullingShaderPropertiesHUAWEI>(1);
        var dataCursor = context.GetDataCursor();
        var internalContext = new MarshallingContext<Adamantium.Vulkan.Core.Interop.VkPhysicalDeviceClusterCullingShaderPropertiesHUAWEI>(nativeSpan, dataCursor);
    ...
    {
        public VkPhysicalDeviceClusterCullingShaderPropertiesHUAWEIMarshaller(Adamantium.Vulkan.Core.PhysicalDeviceClusterCullingShaderPropertiesHUAWEI physicalDeviceClusterCullingShaderPropertiesHUAWEI, ref QuantumBinding.Utils.MarshallingContext<Adamantium.Vulkan.Core.Interop.VkPhysicalDeviceClusterCullingShaderPropertiesHUAWEI> context)
        {
