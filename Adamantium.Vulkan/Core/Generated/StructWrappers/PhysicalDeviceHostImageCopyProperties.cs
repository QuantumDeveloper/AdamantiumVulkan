...
public unsafe partial class PhysicalDeviceHostImageCopyProperties : IMarshallableObject, IMarshallableFromPointer, IMarshallable<Adamantium.Vulkan.Core.Interop.VkPhysicalDeviceHostImageCopyProperties>
{
    public PhysicalDeviceHostImageCopyProperties()
    {
    }

    public PhysicalDeviceHostImageCopyProperties(in Adamantium.Vulkan.Core.Interop.VkPhysicalDeviceHostImageCopyProperties native)
    {
    ...
    public static implicit operator PhysicalDeviceHostImageCopyProperties(Adamantium.Vulkan.Core.Interop.VkPhysicalDeviceHostImageCopyProperties p)
    {
    ...
    public int GetSize()
    {
        var size = QuantumBinding.Utils.SizeOfCache<Adamantium.Vulkan.Core.Interop.VkPhysicalDeviceHostImageCopyProperties>.Size;
    ...
    public void MarshalTo(ref MarshallingContext<Adamantium.Vulkan.Core.Interop.VkPhysicalDeviceHostImageCopyProperties> context)
    {
        new VkPhysicalDeviceHostImageCopyPropertiesMarshaller(this, ref context);
    }

    public void MarshalFrom(in Adamantium.Vulkan.Core.Interop.VkPhysicalDeviceHostImageCopyProperties native)
    {
    ...
    {
        var nativeSpan = context.AllocateNative<Adamantium.Vulkan.Core.Interop.VkPhysicalDeviceHostImageCopyProperties>(1);
        var dataCursor = context.GetDataCursor();
        var internalContext = new MarshallingContext<Adamantium.Vulkan.Core.Interop.VkPhysicalDeviceHostImageCopyProperties>(nativeSpan, dataCursor);
    ...
    public void MarshalFromPointer(void* native)
    {
        ...
        MarshalFrom(in *(Adamantium.Vulkan.Core.Interop.VkPhysicalDeviceHostImageCopyProperties*)native);
    }
    private ref struct VkPhysicalDeviceHostImageCopyPropertiesMarshaller
    {
        public VkPhysicalDeviceHostImageCopyPropertiesMarshaller(Adamantium.Vulkan.Core.PhysicalDeviceHostImageCopyProperties physicalDeviceHostImageCopyProperties, ref QuantumBinding.Utils.MarshallingContext<Adamantium.Vulkan.Core.Interop.VkPhysicalDeviceHostImageCopyProperties> context)
        {
