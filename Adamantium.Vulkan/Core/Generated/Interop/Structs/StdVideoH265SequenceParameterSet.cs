...
public unsafe partial struct StdVideoH265SequenceParameterSet
{
    ...
    public Adamantium.Vulkan.Core.Interop.StdVideoH265ProfileTierLevel* pProfileTierLevel;
    public Adamantium.Vulkan.Core.Interop.StdVideoH265DecPicBufMgr* pDecPicBufMgr;
    public Adamantium.Vulkan.Core.Interop.StdVideoH265ScalingLists* pScalingLists;
    public Adamantium.Vulkan.Core.Interop.StdVideoH265ShortTermRefPicSet* pShortTermRefPicSet;
    public Adamantium.Vulkan.Core.Interop.StdVideoH265LongTermRefPicsSps* pLongTermRefPicsSps;
    public Adamantium.Vulkan.Core.Interop.StdVideoH265SequenceParameterSetVui* pSequenceParameterSetVui;
    public Adamantium.Vulkan.Core.Interop.StdVideoH265PredictorPaletteEntries* pPredictorPaletteEntries;
}
