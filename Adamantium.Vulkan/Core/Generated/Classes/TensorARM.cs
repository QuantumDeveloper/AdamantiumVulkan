...
public unsafe partial class TensorARM : IUnmanagedWrapper<Adamantium.Vulkan.Core.Interop.VkTensorARM_T>
{
    ...
    public TensorARM(in Adamantium.Vulkan.Core.Interop.VkTensorARM_T __Instance)
    {
    ...
    {
        return t?.__Instance ?? new Adamantium.Vulkan.Core.Interop.VkTensorARM_T();
    }

    public static implicit operator TensorARM(Adamantium.Vulkan.Core.Interop.VkTensorARM_T t)
    {
