    ...
    public static SlangcSession SessionCreate(string[] searchPaths, int searchPathCount, string[] defineNames, string[] defineValues, int defineCount, string profile, in System.ReadOnlySpan<SlangcCompilerOption> options, int optionCount, nuint loadFile, ref nuint userData)
    {
        ...
        fixed (byte* bufferPtr = mainBuffer)
        {
            try
            {
                ...
                Adamantium.Vulkan.Slang.Interop.SlangcCompilerOption* arg6 = null;
                if (!options.IsEmpty)
                {
                    arg6 = QuantumBinding.Utils.MarshalContextUtils.MarshalArrayOfWrappers<Adamantium.Vulkan.Slang.SlangcCompilerOption, Adamantium.Vulkan.Slang.Interop.SlangcCompilerOption>(options, ref currentCursor);
                }
                void* arg9 = (void*)userData;
                var result = Adamantium.Vulkan.Slang.Interop.SlangInterop.slangc_session_create(arg0, searchPathCount, arg2, arg3, defineCount, arg5, arg6, optionCount, loadFile, &arg9);
                userData = (nuint)arg9;
                return result;
            }
            finally
